...
export default function LotteryEntrance() {
    ...
    const [entranceFee, setEntranceFee] = useState("0") // start at 0
    const [numPlayers, setNumplayers] = useState("0") // start at 0
    const [recentwinner, setRecentWinner] = useState("0") // start at 0
